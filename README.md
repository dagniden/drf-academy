...
- [ ] Создать класс разрешений для модераторов в `permissions.py`
- [ ] Реализовать проверку через `has_permission()`
- [ ] Создать фикстуру или кастомную команду для групп
- [ ] Настроить права для ViewSet через `get_permissions()`
- [ ] Разрешить модераторам просмотр и редактирование уроков и курсов
- [ ] Запретить модераторам создание и удаление уроков и курсов
- [ ] Протестировать через Postman
...
- [ ] Создать класс разрешений `IsOwner` в `permissions.py`
- [x] Реализовать автопривязку объектов через `perform_create()`
- [ ] Настроить права доступа с логическими операторами
- [ ] Разрешить пользователям видеть, редактировать и удалять только свои объекты
- [ ] Протестировать через Postman
